        ...
        <div v-for="(item, index) in displayResearchNotes" :key="index" class="mobile-currency-card">
            <div class="label-and-cta">
                ...
                <div class="svg-ctas">
                    ...
                    <svg @click="getRecipeValue(item.name, item.output_item_id, item.recipe_id, 1)" class="icon clickable" width="22" height="16" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const getRecipeValue = (recipeName, itemId, recipeId, recipeQty) => {
    const url = `../tools/recipe-value?requestedRecipe=${recipeName}&itemId=${itemId}&recipeId=${recipeId}&qty=${recipeQty}`;
