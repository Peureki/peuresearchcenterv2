...
// Picture guides
import RiverFish from '@/imgs/guides/fishing/Gendarran_Fields_River_Fish.webp'
...
const guides = ref([
    {
        instruction: "From the waypoint, head directly north, following the river.",
        waypointName: "Lionbridge Waypoint",
        waypointLink: "[&BJsDAAA=]",
        img: RiverFish,
        alt: "River Fish Guide",
    },
])
