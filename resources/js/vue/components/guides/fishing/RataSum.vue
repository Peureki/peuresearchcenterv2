...
// Picture guides
import SaltwaterFish from '@/imgs/guides/fishing/Rata_Sum_Saltwater_Fish.webp'
...
const guides = ref([
    {
        instruction: "Head slightly west from the waypoint and go around the port. There will many pools near the port. When you get the end of the route, it's best to waypoint back.",
        waypointName: "Port Waypoint",
        waypointLink: "[&BAcFAAA=]",
        img: SaltwaterFish,
        alt: "Saltwater Fish Guide",
    },
])
