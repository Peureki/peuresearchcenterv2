...
// Picture guides
import CoastalFish from '@/imgs/guides/fishing/Lions_Arch_Coastal_Fish.webp'
...
const guides = ref([
    {
        instruction: "There's always a pool west of the waypoint. From there, head into the Harbor and most of the pools will be along the port. When you get deeper into Sanctum Harbor, there may be some in the middle.",
        waypointName: "Farshore Waypoint",
        waypointLink: "[&BDMEAAA=]",
        img: CoastalFish,
        alt: "Coastal Fish Guide",
    },
])
