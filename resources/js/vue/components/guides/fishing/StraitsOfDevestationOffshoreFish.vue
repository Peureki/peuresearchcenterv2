...
// Picture guides
import OffshoreFish from '@/imgs/guides/fishing/Straits_of_Devestation_Offshore_Fish.webp'
...
const guides = ref([
    {
        instruction: "Head above the waypoint. There are many pools surrounding the area. The area is pretty vague, but when you look at the map, the pools seem to be always within the area where there aren't any land or shipwrecks.",
        waypointName: "Wesper Bell Waypoint",
        waypointLink: "[&BPICAAA=]",
        img: OffshoreFish,
