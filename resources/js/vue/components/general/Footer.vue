<template>
    <section class="main">
        <div class="content-section">
            <Disclaimer
                message="The choyas are working hard to build this website. This is an 'early release'. To check patch notes, check out the #prc-patch-notes channel on Discord. Version 0.3.6"
            />
        </div>
            ...
            <div class="content-section">
                <div class="footer-container">
                    ...
                    <span>
                        ...
                        <router-link to="/general/support" class="link small-subtitle">Support the choyas</router-link>
                    </span>
