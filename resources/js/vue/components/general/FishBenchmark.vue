...
.fishing-hole-container:hover{
    border: 1px solid var(--color-link);
}
.fishing-hole-container:hover svg.arrow,
.fishing-hole-container:focus svg.arrow{
