<template>
    ...
    <div class="mobile-nav-container" v-if="isMobile" @click="">
        <div class="mobile-nav">
            ...
            <svg v-if="mobileHamburger" @click="mobileHamburger = !mobileHamburger; hamburgerClick = 'hamburger'; mainNavToggle = !mainNavToggle" class="hamburger" width="25" height="17" viewBox="0 0 25 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-if="!mobileHamburger" @click="mobileHamburger = !mobileHamburger; hamburgerClick = 'x'; mainNavToggle = !mainNavToggle" class="mobile-close" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
