...
import BalthazarChoya from '@/imgs/choyas/Balthazar_Choya.png'
...
const researchers = [
    ...
    'Nexius.5639',
    'Frenchie.7208',
    'IntensePrehistoricButterfly.6489',
    'Barraind.7324',
    'Tiffy.2305',
    'StarEyes.8712',
    'Odeh.9310',
...
.comment{
    ...
    flex-direction: column;
    gap: var(--gap-content);
    max-width: clamp(15rem, 100vw, 40rem);
}
.benefits > li {
    display: flex;
    align-items: center;
...
.support-card:hover{
    border: var(--border-general-link);
}
