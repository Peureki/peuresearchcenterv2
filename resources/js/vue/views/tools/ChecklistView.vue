<template>
        ...
        <section class="main-sticky">
            <div class="content-section">
                ...
                <div class="icons">
                    ...
                    >
                        <path d="M13.8436 1.42344C13.5373 0.865625 12.8061 0.5 11.9998 0.5C11.1936 0.5 10.4623 0.865625 10.1561 1.42344L2.65608 14.9234L0.156078 19.4234C-0.268922 20.1875 0.212329 21.0641 1.23108 21.3828C2.24983 21.7016 3.41858 21.3406 3.84358 20.5766L5.83108 17H18.1623L20.1498 20.5766C20.5748 21.3406 21.7436 21.7016 22.7623 21.3828C23.7811 21.0641 24.2623 20.1875 23.8373 19.4234L21.3373 14.9234L13.8373 1.42344H13.8436ZM16.4998 14H7.49983L11.9998 5.9L16.4998 14Z" fill="var(--color-link)"/>
                    ...
                    <div class="import-and-save">
                        ...
                        >
                            <path d="M12 8L8 4V7H0V9H8V12M18 14V2C18 1.46957 17.7893 0.960859 17.4142 0.585786C17.0391 0.210714 16.5304 0 16 0H4C3.46957 0 2.96086 0.210714 2.58579 0.585786C2.21071 0.960859 2 1.46957 2 2V5H4V2H16V14H4V11H2V14C2 14.5304 2.21071 15.0391 2.58579 15.4142C2.96086 15.7893 3.46957 16 4 16H16C16.5304 16 17.0391 15.7893 17.4142 15.4142C17.7893 15.0391 18 14.5304 18 14Z" fill="var(--color-link)"/>
                        ...
                        >
                            <path d="M18 4V16C18 16.55 17.8043 17.021 17.413 17.413C17.0217 17.805 16.5507 18.0007 16 18H2C1.45 18 0.979333 17.8043 0.588 17.413C0.196667 17.0217 0.000666667 16.5507 0 16V2C0 1.45 0.196 0.979333 0.588 0.588C0.98 0.196667 1.45067 0.000666667 2 0H14L18 4ZM16 4.85L13.15 2H2V16H16V4.85ZM9 15C9.83333 15 10.5417 14.7083 11.125 14.125C11.7083 13.5417 12 12.8333 12 12C12 11.1667 11.7083 10.4583 11.125 9.875C10.5417 9.29167 9.83333 9 9 9C8.16667 9 7.45833 9.29167 6.875 9.875C6.29167 10.4583 6 11.1667 6 12C6 12.8333 6.29167 13.5417 6.875 14.125C7.45833 14.7083 8.16667 15 9 15ZM3 7H12V3H3V7ZM2 4.85V16V2V4.85Z" fill="var(--color-link)"/>
    ...
    <Loading v-if="checklist.length == 0 || currentlyFetching" :width="200" :height="200"/>
    <Footer/>
</template>
