    ...
    <section class="main">
        <div class="content-section">
            ...
            <div v-if="repeatableRewardTracks" v-for="(achievement, index) in repeatableRewardTracks" :key="index" class="reward-track-container">
                ...
                <div class="next-reward-container">
                    <!-- <p>Next reward: </p> -->

                    <!-- <img class="card-main-icon" :src="nextReward(achievement, sortedCommendations[index]).icon" :alt="nextReward(achievement, sortedCommendations[index]).name" :title="nextReward(achievement, sortedCommendations[index]).name"> -->

                    <!-- <p>{{ nextReward(achievement, sortedCommendations[index]).name }}</p> -->
                ...
                <!--
                    ...
                    *
                -->
                <div v-if="expand[index]" class="mobile-benchmark-details-container">
                    <div v-for="(n, subIndex) in 20" class="mobile-drops-container">
...
const getUserRewardTrackProgress = async () => {
    try {
        ...
        if (response){
            ...
            expand.value = repeatableRewardTracks.value.map(() => false);
        }
    } catch (error){
...
const opacityRewardsAchieved = (achievement, rewardIndex) => {
    ...
    return rewardIndex >= currentProgressIndex ? 1 : 0.3; 
}
