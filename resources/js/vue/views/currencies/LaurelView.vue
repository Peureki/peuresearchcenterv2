...
// Get currency icons
import CurrencyIcon from '@/imgs/icons/Laurel.png'
...
const currencyName = ref('Laurels');
...
const url = `../api/currencies/laurel/${localStorage.sellOrderSetting}/${localStorage.taxSetting}`,
    bags = ref(null);
